        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 4 }}>
          ...
          <Box>
            ...
            <Typography sx={{ color: '#64748b', fontSize: 14 }}>
              Withdraw cash via an agent — a 1.5% fee applies
            </Typography>
          </Box>
        </Box>
            ...
            <Box component="form" onSubmit={handleSubmit} noValidate>
              <Stack spacing={2.5}>
                ...
                <Button type="submit" fullWidth variant="contained" disabled={loading}
                  sx={{ height: 50, fontSize: 15, fontWeight: 700, textTransform: 'none', borderRadius: '12px', background: `linear-gradient(135deg, ${COLOR}, #d97706)`, boxShadow: `0 0 24px ${COLOR}40`, '&:hover': { background: `linear-gradient(135deg, #fcd34d, ${COLOR})` }, '&:disabled': { background: 'rgba(245,158,11,0.3)', color: 'rgba(255,255,255,0.4)' } }}>
