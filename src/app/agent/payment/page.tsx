...
export default function AgentPayment() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setPaidAmount(null); setServiceFee(null);
    ...
    try {
      ...
      setPaidAmount(Number(formData.amount));
    ...
    <DashboardLayout>
      <Box>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 4 }}>
          ...
          <Box>
            <Typography sx={{ fontWeight: 800, fontSize: 22, color: '#1e293b', letterSpacing: '-0.3px' }}>Make Payment</Typography>
            <Typography sx={{ color: '#64748b', fontSize: 14 }}>Pay a merchant from your agent wallet</Typography>
          </Box>
        </Box>
              ...
              <Box sx={{ display: 'flex', gap: 3, flexWrap: 'wrap' }}>
                ...
                {paidAmount !== null && (
                  <Box>
                    ...
                    <Typography sx={{ fontWeight: 800, color: '#1e293b', fontSize: 18, mt: 0.5 }}>৳ {paidAmount.toFixed(2)}</Typography>
                  </Box>
                )}
                {serviceFee !== null && (
                  <Box>
